...
!function(a,b){"use strict";"object"==typeof exports&&module?module.exports=b():"function"==typeof define&&define.amd?define(b):a.RouterRouter=b()}("object"==typeof window&&window||this,function(){"use strict";var a=/[\-{}\[\]+?.,\\\^$|#\s]/g,b=/(\(\?)?:\w+/g,c=/\((.*?)\)/g,d=/\*\w+/g,e=/^[#\/]|\s+$/g,f=/\/$/,g=function(a){return"function"==typeof a},h=function(a){this.options="undefined"!=typeof a?a:{},this.options.routes&&(this.routes=this.options.routes),this.location=window.location,this._bindRoutes()};return h.prototype={_bindRoutes:function(){if(this.routes)for(var a,b=Object.keys(this.routes);"undefined"!=typeof(a=b.pop());)this.route(a,this.routes[a])},_extractParameters:function(a,b){var c=a.exec(b).slice(1);return c.map(function(a){return a?decodeURIComponent(a):null})},_getFragment:function(a){return a.replace(e,"").replace(f,"")},_routeToRegExp:function(e){return e=e.replace(a,"\\$&").replace(c,"(?:$1)?").replace(b,function(a,b){return b?a:"([^/?]+)"}).replace(d,"([^?]*?)"),new RegExp("^"+e+"(?:\\?([\\s\\S]*))?$")},route:function(a,b,c){a=this._routeToRegExp(a),g(b)&&(c=b,b=""),c||(c=this.options[b]);var d=this._getFragment(this.location.pathname);if(a.test(d)){var e=this._extractParameters(a,d);g(c)&&c.apply(this,e)}return this}},h});